...
import '/gpt/empty_list_1/empty_list1_widget.dart';
                    ...
                    Align(
                      ...
                      child: FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          ...
                          setState(() {});
                          _model.chatGPTResponse = await GetTriviaCall.call(
                            sessionID: FFAppState().sessionId,
                            token: FFAppConstants.apiToken,
                            agentID: FFAppConstants.chatAgentID,
                          ...
                          if ((_model.chatGPTResponse?.succeeded ?? true)) {
                            _model.jsonifiedResponse =
                                await actions.jsonifyResponse(
                              (_model.chatGPTResponse?.bodyText ?? ''),
                            );
                            _model.aiResponding = false;
                            _model.chatHistory = functions.saveChatHistory(
                                _model.chatHistory, _model.jsonifiedResponse!);
                            setState(() {});
                            setState(() {
